...
public class RegisteredClientRepositoryConfiguration {
    ...
    @Bean
    public RegisteredClientRepository registeredClientRepository(TokenSettings settings) {
        return new InMemoryRegisteredClientRepository(
                RegisteredClient
                        ...
                        .redirectUri("http://localhost:5000/auth/code")
                        .redirectUri("http://localhost:3030/auth/code")
